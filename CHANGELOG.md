...
- CLI with convert, extract, fetch, media, image compress, video compress, pdf merge/split/optimize commands
...
- `morphase backend list/verify/install/update` for backend management
- `morphase serve` for local HTTP API (experimental)
...
- Stable plugins: pandoc, libreoffice, ffmpeg, imagemagick, qpdf, trafilatura, ytdlp
